...
insert into product(Pname, Classification_kids, Category, Feedback, Size) values
	  ('Fone Bluetooth',false,'Eletrônico','4',null),
	  ('Noiva do chuck',true,'Brinquedos','3',null),
	  ('Camiseta',true,'Vestimenta','5',null),
	  ('Microfone',False,'Eletrônico','4',null),
	  ('Rack',False,'Brinquedos','3','3x57x80'),
	  ('Bolinho de Queijo',False,'Alimentos','2',null),
	  ('Alexa',False,'Eletrônico','3',null);

desc orders;
insert into orders (idOrderClient, OrderStatus, OrderDescription, ShippingCost) values
